---
name: update
description: Fixture only — stands in for a tracker pack's update_item implementation so the manifest validator's skill-exists check resolves. Implements nothing and is never invoked.
---

# update

A fixture. The manifest beside it maps `update_item` to this directory, and the manifest validator
